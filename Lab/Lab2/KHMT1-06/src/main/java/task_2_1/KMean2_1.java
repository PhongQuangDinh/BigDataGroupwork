...
public class KMean2_1 {
    ...
    public static class KMeansReducer extends Reducer<IntWritable, Text, IntWritable, Text> {
        ...
        public void reduce(IntWritable key, Iterable<Text> values, Context context)
            ...
            for (Text point : values) {
                ...
                multipleOutputs.write("task21classes", new IntWritable(key.get() + 1), point);
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!isDone) {
            ...
            // define named output
            MultipleOutputs.addNamedOutput(job, "task21classes", TextOutputFormat.class, Text.class, Text.class);
